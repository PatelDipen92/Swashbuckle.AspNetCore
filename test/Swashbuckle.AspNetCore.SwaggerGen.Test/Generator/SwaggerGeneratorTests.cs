    ...
    public class SwaggerGeneratorTests
    {
        ...
        public void GetSwagger_GeneratesQueryParams_ForAllUnboundParams()
        {
            var subject = Subject(setupApis: apis => apis
                ...
                .Add("POST", "collection", nameof(FakeActions.AcceptsUnboundComplexType)));
        ...
        [Theory]
        [InlineData(nameof(FakeActions.AcceptsModelBoundParams), "paramWithNoAttributes", false)]
        //[InlineData(nameof(FakeActions.AcceptsModelBoundParams), "paramWithBindRequired", true)]
        [InlineData(nameof(FakeActions.AcceptsDataAnnotatedParams), "paramWithRequiredAndNonNullDefault", false)]
        [InlineData(nameof(FakeActions.AcceptsDataAnnotatedParams), "paramWithRequiredAndNullDefault", false)]
        [InlineData(nameof(FakeActions.AcceptsModelBoundType), "PropertyWithNoAttributes", false)]
        [InlineData(nameof(FakeActions.AcceptsModelBoundType), "PropertyWithBindRequired", true)]
        [InlineData(nameof(FakeActions.AcceptsDataAnnotatedType), "PropertyWithRequiredAndNonNullDefault", false)]
        [InlineData(nameof(FakeActions.AcceptsDataAnnotatedType), "PropertyWithRequiredAndNullDefault", true)]
        ...
        public void GetSwagger_DescribesParametersInCamelCase_IfSpecifiedBySettings()
        {
            ...
            Assert.Equal("propertyWithNoAttributes", operation.Parameters[0].Name);
            Assert.Equal("propertyWithBindRequired", operation.Parameters[1].Name);
        }
